...
public class WorldCreateScreen extends WidgetScreen {
    ...
    public void show() {
        super.show();
        // A fresh form every time, so an old name is not created twice by accident.
        nameField.clear();
        seedField.clear();
    }
    ...
    private void createWorld() {
        ...
        LOGGER.info("Creating world '{}' with seed {}", name, seed);
        game.screens().createWorld(name, seed);
    }
